...
Planner: Claude Fable 5 (max effort). Status: **v4 — revised per Codex re-review pass 3 (M1–M8); awaiting re-review pass 4, then Yixun approval.**
