#!/bin/bash
# Post-STOP capacity-videos job (2026-08-09, Yixun-approved ~1 v6e-8 hour). RAN AND SUCCEEDED as
# 20260809-173808-13c3cadc-capvideos-yixun (attempt 2) at tip 6f3146a; kept for provenance/re-runs.
