...
RULED="7f23ac37915d46bae68fbe3e2c51d900689c1b71"  # F9 ceremony tip (runtime peaks + enforced ladder order)
...
tpu create v6 -n 8 --worker0-only --name "exp06-m1g-fitprobe-yixun" \
  --code-dir . \
