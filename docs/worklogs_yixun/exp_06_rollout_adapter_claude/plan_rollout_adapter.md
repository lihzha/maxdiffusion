...
v2.1 (2026-08-07). Planner: Claude Fable 5. Status: DRAFT — pending plan-review pass 3, then Yixun approval (§11). v2.1 vs v2: the pass-2 residue — §3e wrong-action assignment = cohort-level seeded derangement (persisted permutation+hash; batch-1 executable); §3d cadence pinned at every-1,000-updates for both arms.
