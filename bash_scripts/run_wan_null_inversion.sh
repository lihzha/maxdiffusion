...
NULL_TRANSFER_NULLS_URI="${NULL_TRANSFER_NULLS_URI:-}"   # J1c: the a3_nulls.npz transfer_probe replays
...
echo "NULL_TRANSFER_NULLS_URI=${NULL_TRANSFER_NULLS_URI}"
...
"${WATCHDOG[@]}" python src/maxdiffusion/run_wan_null_inversion.py \
  ...
  null_transfer_nulls_uri="${NULL_TRANSFER_NULLS_URI}" \
