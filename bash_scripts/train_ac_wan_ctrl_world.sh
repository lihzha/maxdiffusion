...
python src/maxdiffusion/train_wan.py \
    ...
    run_name=ac_wan_droid_history_fewer_frames_downsampled_zero_init_ctrl_world \
    ...
    wandb_project='wan-ac-history-fewer-frames-no-text-downsampled-zero-init-ctrl-world' \
...
# tpu create v6 --name train_ac_wan_ctrl_world -n 64 --setup-cmd "" --priority 0 --max-attempts 100 -- bash bash_scripts/train_ac_wan_ctrl_world.sh